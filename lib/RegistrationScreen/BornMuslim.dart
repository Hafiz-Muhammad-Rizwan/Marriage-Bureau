...
class Bornmuslim extends StatefulWidget {
  const Bornmuslim({super.key});

  @override
  State<Bornmuslim> createState() => _BornmuslimState();
}

class _BornmuslimState extends State<Bornmuslim> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Expanded(
            child: Consumer<BornMuslimProvider>(
                    ...
                    return ListTile(
                      ...
                      onTap: ()async {
                        ...
                        Navigator.push(
                          context,
                          PageRouteBuilder(
                            pageBuilder: (context, animation, secondaryAnimation) => Intetrestscreen(),
