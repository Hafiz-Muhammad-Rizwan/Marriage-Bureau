      ...
      return Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            Expanded(
              child: Consumer<PrayerFrequencyProvider>(
                builder: (context, provider, child) {
                  return ListView.builder(
                    itemCount: provider.frequencies.length,
                    itemBuilder: (context, index) {
                      final frequency = provider.frequencies[index];
                      ...
                      return ListTile(
                        ...
                        onTap: ()async {
                          provider.selectFrequency(frequency);
                          ...
                          Navigator.push(
                            context,
                            PageRouteBuilder(
                              pageBuilder: (context, animation, secondaryAnimation) => Halalfood(),
